...
```
start.sh  ──▶ main_tui.py (AdaptiveDJWithTUI)      the only entry point
...
`data/embeddings/` is different — it is a five-minute rebuild (`python3 generate_embeddings.py --force`),
not a throwaway.
