...
echo "    P             Play the selected cloud track now (asks to confirm)"
echo "    B             Cycle the frame drawn behind the cloud"
echo "    T             Cycle panes: split / cloud / history / console"
